...
HD_PWD='C:/Users/mehme/Documents/decoder/decoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Fullmodule.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Fullmodule.tcl
