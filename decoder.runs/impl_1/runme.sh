...
HD_PWD='C:/Users/mehme/Documents/decoder/decoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Fullmodule.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Fullmodule.tcl -notrace
